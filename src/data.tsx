export const data = {
  products: [
    {
      product: "FALL LIMITED EDITION SHOES",
      description: `This limited edition shoes is a super cute addition to any outfit. Featuring one main compartment and a front zippered pocket.Small and light, this shoe is the perfect throw-on-and-go miniature shoe.`,
      price: {
        newprice: "$150.00",
        oldprice: "$250.00",
        discount: "50%",
